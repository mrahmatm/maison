...
--
-- Host: localhost:3306
-- Generation Time: Jul 24, 2023 at 02:08 AM
...
CREATE TABLE `clinic` (
  ...
  `clinic_lateTolerance` int NOT NULL,
  `clinic_CBQTolerance` int NOT NULL,
  `clinic_earlyTolerance` int NOT NULL,
  `clinic_appointmentInterval` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `clinic` (`clinic_capacity`, `clinic_LatLng`, `clinic_maxRadius`, `clinic_SLQMaxSize`, `clinic_lateTolerance`, `clinic_CBQTolerance`, `clinic_earlyTolerance`, `clinic_appointmentInterval`) VALUES
(15, 'LatLng(5.26213, 103.165247)', 196, 5, 20, 10, 15, 15);
...
('GEN', 'General Unit', 'Handles general illness or injuries.', 7),
...
INSERT INTO `patient` (`patient_ICNum`, `patient_name`, `patient_gender`, `patient_age`, `patient_email`, `patient_password`, `patient_phoneNum`) VALUES
...
('GEN-331', '000816-10-2681', 'FUMINA', 'F', 23, 'winning@gmail.com', '019-3332571', 'DR', 'F', 'GEN'),
...
('LAB-2023-3', '010606-10-1281', 'YUJU-ubah2', 'M', 22, 'gf@yahoo.com', '012-3455612121', 'DR', 'F', 'GEN'),
...
--
ALTER TABLE `appointment`
  ADD CONSTRAINT `app_queue` FOREIGN KEY (`q_ID`) REFERENCES `queue` (`q_ID`) ON DELETE CASCADE ON UPDATE CASCADE,
